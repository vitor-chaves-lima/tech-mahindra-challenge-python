...
from api.models import SignUpUserRequestPayload, UserResponse
...
@api_router.post("/auth/sign-up", status_code=status.HTTP_201_CREATED, response_model=UserResponse)
